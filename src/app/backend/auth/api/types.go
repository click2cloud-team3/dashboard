...
const (
	// Resource clustermanagement that are used as encryption key storage. Can be accessible by multiple dashboard replicas.
	EncryptionKeyHolderName = "kubernetes-dashboard-key-holder"

	// Resource clustermanagement that are used as certificate storage for custom certificates used by the user.
...
// ProtectedResource represents basic clustermanagement about resource that should be filtered out from Dashboard UI.
...
// clustermanagement required to authenticate user.
